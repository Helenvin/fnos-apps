...
- 基于 [simple_sq_music_plus ${UPSTREAM_TAG}](https://github.com/Helenvin/simple_sq_music_plus/releases/tag/${UPSTREAM_TAG}) 多源音乐下载引擎（自研版：新增酷我/酷狗/QQ音乐歌单监听下载）
- 内置自研「发现」页：QQ 25 个榜单匿名浏览、逐首下载、整榜批量下载；歌单广场分类浏览（解析下载需在设置中 QQ 扫码登录）
- 监听下载：网易云/酷我/酷狗/QQ音乐歌单均可在「监听」页添加分享链接自动增量下载
