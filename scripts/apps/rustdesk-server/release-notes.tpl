...
- 基于 [rustdesk-server ${VERSION}](https://github.com/rustdesk/rustdesk-server/releases/tag/${VERSION})（hbbs + hbbr；公钥文件在应用数据目录 data/ 下，客户端 ID/中继服务器填 NAS 地址即可）
- 平台: fnOS
- 端口: 21115-21119（21116 含 UDP）${REVISION_NOTE}
${CHANGELOG}
**国内镜像**:
